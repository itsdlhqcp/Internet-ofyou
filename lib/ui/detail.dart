...
class Detail extends StatefulWidget {
  final String imagetype, url; //URL LAUNCH
...
class _DetailPageState extends State<Detail> {
  ...
  void initState() {
    if (widget.imagetype == 'google') {
      ...
      //   text =
      //       '\nGoogle stores a list of usernames and passwords that you have typed in Google Chrome or Android for logging into varyous websites. They even have a website too where you can view all these passwords in plain text.\n\nNote:- you have to login to your google account see this data.';
      // }
        ...
        text =
            '\nGoogle record every search term that you’ve ever typed into their search boxes. They keep a log of every Google ad that you have clicked on varyous websites,Want to see what google logs about you\n\n';
      } else if (widget.url ==
      ...
      image = 'assets/image/fc.jpg';
    } else if (widget.imagetype == 'insta') {
      text =
          "\nAre you in the instagram, check out your data, it contains your posts, likes, comments etc.\n\nNote:- you have to login in the instagram through your browser with userid and password to see your data.\n\n";
