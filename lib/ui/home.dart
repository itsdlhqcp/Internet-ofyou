...
class _AnimationDemoHomeState extends State<AnimationDemoHome> {
  ...
  _sharer() {
    Share.share(" InternetOfyou - What internet knows about you\n" +
      ...
      child: Column(
        ...
        children: <Widget>[
            ...
            onTap: () {
              setState(() {
                Navigator.of(context).push(PageRouteBuilder(
                    pageBuilder: (_, __, ___) => Detail(
                          imagetype: "click",
                          url: 'https://www.inspectlet.com/hello/capturedemo',
                        )));
              });
            },
          ),
          ...
          ListTile(
            ...
            onTap: () {
              _launchInBrowser(
                  'https://chat-web-app-46b89.web.app/chat/-NDZ1mTUyjEyzilWp1ni');
            },
          ),
          Expanded(
            child: Align(
              ...
              child: InkWell(
                onTap: () {
                  _launchInBrowser(
                      'https://www.termsfeed.com/live/5a57c1f4-e9ba-4d07-b73f-f9249ae62a49');
                },
                child: Text(
                  'apps privacy and policies',
                  style: TextStyle(
                      color: Color.fromARGB(255, 247, 154, 125),
                      fontSize: 9,
                      fontFamily: null),
                ),
              ),
